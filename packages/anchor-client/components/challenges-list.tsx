...
export default function ChallengesList({challenge_id, title, desc, completed}) {
  ...
  return (
    <Link href={`/challenges/${challenge_id}`}>
      <div className="my-5 mr-14 p-4 border border-slate-200 dark:border-neutral-600 bg-slate-50 dark:bg-zinc-700 rounded-lg hover:bg-slate-200 dark:hover:bg-zinc-600 cursor-pointer">
